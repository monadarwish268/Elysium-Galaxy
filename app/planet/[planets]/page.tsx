  ...
  return (
    <div className="min-h-screen bg-[#030712] text-slate-100 p-6 md:p-12">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        {/* Planet Hero Banner */}
        <div className="bg-[#0b132b]/80 border border-slate-800/80 rounded-3xl p-8 backdrop-blur-xl flex flex-col md:flex-row items-center gap-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <span className="text-sky-400 text-xs bg-sky-950/50 border border-sky-800/30 px-3 py-1 rounded-full font-medium">
              ...
              <div 
                ...
                className={`p-5 rounded-2xl border cursor-pointer transition-all duration-300 flex flex-col justify-between space-y-3 ${
                  completedActivities.includes(act.id) 
                    ...
                    : 'bg-[#0a1122]/90 border-slate-800/80 hover:border-slate-700 hover:bg-[#0f172a]'
                }`}
              >
                <div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#0a1122] border border-slate-800 rounded-2xl overflow-hidden shadow-xl min-h-[300px] flex flex-col">
              <iframe
                ...
                loading="lazy"
              ></iframe>
              <div className="p-3 bg-[#0b132b] text-slate-400 text-xs flex items-center justify-between border-t border-slate-800">
            ...
            <div className="space-y-3">
              {tripoliPlaces.map((place, idx) => (
                <div key={idx} className="bg-[#0b132b]/80 border border-slate-800 rounded-2xl p-4 flex items-center gap-4 hover:border-sky-500/40 transition">
